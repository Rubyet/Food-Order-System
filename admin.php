<?php
    ...
    $ordersById = $conn->runQuery("SELECT * FROM order_table WHERE 	user_id = 2");
    $total_quantity = 0;
    $total_price = 0;
    $ordersByOrderId = $conn->runQuery("SELECT * FROM order_details WHERE 	order_id = ".$ordersById[23]['id']."");
?>
<!DOCTYPE html>
<html lang="en">
<head>
